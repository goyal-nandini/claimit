    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md animate-scale-in">
        ...
        <div className="flex flex-col items-center mb-8">
          <img src="/claimit-logo.png" alt="ClaimIt" className="h-20 w-auto mb-2" />
          <h2 className="text-xl font-bold text-gray-800" style={{ fontFamily: 'Plus Jakarta Sans' }}>Welcome back</h2>
          <p className="text-sm text-gray-500 mt-1">Sign in to your ClaimIt account</p>
        </div>
