// client/src/pages/PostItemPage.jsx
// Complete file — replace your existing one entirely
                ...
                {preview ? (
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-20 rounded-xl flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                      <span className="text-white text-sm font-medium bg-black bg-opacity-50 px-3 py-1 rounded-lg">
                        Change photo
                      </span>
                    </div>
                  </div>
